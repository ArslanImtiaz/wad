                ...
                <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="c_name" name="c_name" placeholder="Enter your name"
                               required pattern="(^[a-zA-Z]+(([',. -][a-zA-Z ])?[a-zA-Z]*)*$)">
                    </div>
                </div>
                <div class="d-none d-sm-block col-sm-3 col-md-4 col-lg-2 col-xl-2 mt-auto">
                ...
                <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4 mt-3 mt-lg-0">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="c_email" name="c_email" placeholder="Enter your email"
                               onkeyup="checkEmail(this.value)"required pattern="e">
            ...
            <div class="row my-3">
                ...
                <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4">
                    <div class="input-group">
                        ...
                        <input type="password" class="form-control" id="c_password" name="c_password" placeholder="Enter your password" required pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{8,}$" >
                    </div>
                </div>
                <div class="d-none d-sm-block col-sm-3 col-md-4 col-lg-2 col-xl-2 mt-auto">
            ...
            <div class="row my-3">
                ...
                <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4">
                    <div class="input-group">
                        ...
                        <input class="form-control" id="c_country" name="c_country" placeholder="Enter your country" required pattern="[a-zA-Z]{2,}">
                    </div>
                </div>
                <div class="d-none d-sm-block col-sm-3 col-md-4 col-lg-2 col-xl-2 mt-auto">
            ...
            <div class="row my-3">
                ...
                <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4">
                    <div class="input-group">
                        ...
                        <textarea class="form-control" type="file" id="c_address" name="c_address" placeholder="Enter your address" required pattern="^[+]*[(]{0,1}[0-9]{1,4}[)]{0,1}[-\s\./0-9]*$"></textarea>
                    </div>
                </div>
            </div>
            <div class="row my-3">
